...
class CVExample(Node): 
    def __init__(self): 
        ...
        self.declare_parameter('Red_HSV', [0, 10, 100, 255, 100, 255]) 
        self.declare_parameter('Green_HSV', [40, 80, 0, 255, 0, 255])
        self.declare_parameter('Yellow_HSV', [100, 140, 0, 255, 0, 255])
        ...
        self.width = 160
        self.height = 120
        self.area_min = (self.width * self.height) * 0.015
